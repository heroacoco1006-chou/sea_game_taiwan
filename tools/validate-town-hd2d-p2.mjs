...
check(title.includes('previewLegacy') && title.includes('previewPortName') && title.includes('forceLegacy: previewLegacy') && title.includes("portId: previewPortId"), 'Title 缺少沿用目前港口與 renderer 模式的開發預覽返回入口')
